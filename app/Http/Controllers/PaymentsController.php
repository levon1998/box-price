...
class PaymentsController extends Controller
{
    ...
    public function replenishFundsSuccess(Request $request)
    {
        ...
        return redirect('/replenish-funds')->route('profile', ['success' => true, 'balance' => $user->balance, 'sum' => $data->pay]);
    }
    ...
    public function replenishFundsFail(Request $request)
    {
        ...
        return redirect('/replenish-funds')->route('profile', ['success' => false]);
    }
}
